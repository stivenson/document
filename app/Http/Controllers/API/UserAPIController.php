...
use document\Http\Requests\API\CreateUserAPIRequest;
use document\Http\Requests\API\UpdateUserAPIRequest;
use document\User;
use document\Repositories\UserRepository;
...
class UserAPIController extends InfyOmBaseController
{
    ...
    public function register(CreateUserAPIRequest $request)
    {
        ...
        $alldata = $this->userRepository->register($input);

        return $this->sendResponse($alldata, 'Register saved successfully');
    }

    public function editRegister(CreateUserAPIRequest $request,$id){
        $input = $request->all();

        $alldata = $this->userRepository->editRegister($input,$id);
